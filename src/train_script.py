...
# Train the model
training_loop(BatchedWordleEnv(guess_list, answer_list, batch_size=512), actor_critic, optimizer, guess_list, answer_list, word_encodings, save_dir=training_checkpoint_dir,
